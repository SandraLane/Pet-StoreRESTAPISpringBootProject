...
public class GlobalErrorHandler {
	...
	public ExceptionMessage handleNoSuchElementException(
		...
		return buildExceptionMesssage(ex, HttpStatus.NOT_FOUND, webRequest, LogStatus.MESSAGE_ONLY);
	}

	private ExceptionMessage buildExceptionMesssage(NoSuchElementException ex, HttpStatus status,
